...
export function D4({ size = 30, color = '#000' }: IconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" height={size} width={size} fill={color} viewBox="0 0 57.799999 50.099998">
      <path d="M 28,0 V 32.4 L 0,48.6 Z m 0.9,33.9 -28,16.2 h 56 z m 0.9,-1.5 28,16.2 L 29.8,0 Z" />
    </svg>
  );
}

export function D6({ size = 30, color = '#000' }: IconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" height={size} width={size} fill={color} viewBox="0 0 68.599998 78.699997">
...
export function D8({ size = 30, color = '#000' }: IconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" height={size} width={size} fill={color} viewBox="0 0 68.199997 77.655998">
...
export function D10({ size = 30, color = '#000' }: IconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" height={size} width={size} fill={color} viewBox="40 40 98.140579 96.090897">
...
export function D12({ size = 30, color = '#000' }: IconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" height={size} width={size} fill={color} viewBox="0 0 68.300003 65.199997">
...
export function D20({ size = 30, color = '#000' }: IconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" height={size} width={size} fill={color} viewBox="0 0 68.199997 77.199997">
